      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Supply Chain Management</h1>
         ...
         <div class="bg-light mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area">
                    ...
                    <canvas id="ITS" style="position: relative; height:600vh; width:400vw"></canvas>
                    </div>
                </div>
                </div>
              </div>
            <div class="col-xl-6 col-lg-7">
              <div class=" bg-light mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area">
                  <h6 class="bg-dark text-white font-weight-bold ">Target = 6</h6>
                    <canvas id="ITL"style="position: relative; height:400vh; width:400vw"></canvas>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-7">
              <div class=" mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background:linear-gradient(to right,#006600, #66ff33);">
                  <h6 class="m-0 font-weight-bold text-white">Carrying Cost Of Inventory</h6>
            ...
            <div class="col-xl-6 col-lg-7 mr-0 p-0">
              <div class=" mb-4 " >
                ...
                <div class="card-body row">
                  ...
                  <h6 class=" text-dark">
                  You Hit the target of <span class="font-weigth bold">92.4%</span>
                  </h6>     
                  </div>

                       <!-- kolom ke 2  -->
                    <div class="container-fluid">
                   <canvas id="InventoryAccuracy"></canvas>
                    </div>
                  </div>
                </div>
              </div>
...
<div class="card shadow mb-4">
     ...
     <div class="col-xl-6 col-lg-7">
       ...
       <div class = "row">
       <canvas id ="barpie"style="position: relative; height:400vh; width:400vw"></canvas>
       </div>
       </div>
     </div>
   </div>
